      ...
      <main className="max-w-3xl w-full flex flex-col items-center text-center space-y-12">
        <div className="space-y-6">
          ...
          <p className="text-xl sm:text-2xl text-zinc-400 max-w-2xl mx-auto font-light leading-relaxed">
            Know exactly where your money goes. Secure, simple, and beautifully designed.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4">
          <Button size="lg" className="h-14 px-8 text-lg bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-medium transition-all shadow-[0_0_40px_-10px_rgba(79,70,229,0.5)]">
            Get Started
          </Button>
          <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full font-medium border-zinc-800 text-zinc-300 hover:text-white hover:bg-zinc-900 bg-zinc-950/50">
            Learn More
          </Button>
        </div>
          ...
          <Card className="bg-zinc-900/50 border-zinc-800/50 backdrop-blur-sm">
            ...
            <CardContent>
              <CardDescription className="text-zinc-400">
                Your financial data stays yours. We don't sell or share your subscription habits.
              </CardDescription>
            </CardContent>
          </Card>
          <Card className="bg-zinc-900/50 border-zinc-800/50 backdrop-blur-sm">
            ...
            <CardContent>
              <CardDescription className="text-zinc-400">
                Get notified before your next billing cycle hits. Never pay for forgotten subs.
              </CardDescription>
            </CardContent>
          </Card>
          <Card className="bg-zinc-900/50 border-zinc-800/50 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-zinc-200">Beautiful Insights</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-zinc-400">
                Understand your spending at a glance with clean, actionable dashboards.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
