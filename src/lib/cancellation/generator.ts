...
export const CANCELLATION_REASONS: CancellationReason[] = [
  { id: 'expensive', label: 'Too expensive', text: 'I am finding the subscription too expensive for my current budget.' },
  { id: 'unused', label: "Don't use it anymore", text: 'I am no longer using the service enough to justify the cost.' },
  { id: 'alternative', label: 'Found better alternative', text: 'I have found an alternative service that better meets my needs.' },
...
export function generateCancellationEmail(
  ...
  if (merchant.merchant.match(/bank|insurance|cred|prime/i)) templateType = 'formal';
