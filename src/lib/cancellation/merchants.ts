...
export const merchants: MerchantCancellationInfo[] = [
  // Global & Popular Entertainment
  {
    ...
    cancellationPolicy: "Cancel anytime. You will have access until the end of your billing cycle.",
    difficulty: "easy"
  },
  {
    ...
    cancellationPolicy: "Refunds may be provided if you haven't used any Prime benefits.",
    difficulty: "medium"
  },
  {
    merchant: "Spotify",
    ...
    cancellationPolicy: "Keep your premium features until the next billing date.",
    difficulty: "easy"
  },
  {
    ...
    cancellationPolicy: "Benefits continue until the end of your billing period.",
    difficulty: "easy"
  },
  {
  ...
  // Indian Food & Delivery
  {
    ...
    cancellationPolicy: "Cancellation must be done via the Swiggy App. No prorated refunds.",
    difficulty: "medium",
    instructions: [
      "Open the Swiggy App",
      "Go to your Profile",
  ...
  },
  {
    ...
    cancellationPolicy: "Cancellation via the app. Active until the end of the term.",
    difficulty: "medium",
    instructions: [
      "Open the Zomato App",
  ...
  },
  {
    ...
    cancellationPolicy: "Contact support for any ongoing subscriptions or wallet refunds.",
    difficulty: "hard",
    instructions: [
  ...
  // Tech & Productivity
  {
    ...
    cancellationPolicy: "You'll keep your storage until the end of your billing cycle.",
    difficulty: "easy"
  },
  {
    merchant: "iCloud",
  ...
  },
  {
    ...
    cancellationPolicy: "Turn off recurring billing or cancel for a prorated refund if eligible.",
    difficulty: "hard",
    instructions: [
  ...
  },
  {
    ...
    cancellationPolicy: "Access Pro features until the end of your billing cycle.",
    difficulty: "easy"
  },
  {
  ...
  },
  {
    ...
    cancellationPolicy: "Cancel before your next billing date to avoid charges.",
    difficulty: "medium"
  },
  ...
  },
  {
    ...
    cancellationPolicy: "Cancellation effective at the end of the current billing cycle.",
    difficulty: "medium"
  },
  {
    merchant: "Zee5",
  ...
  },
  {
    ...
    cancellationPolicy: "Cancel from the account section in the app or website.",
    difficulty: "easy"
  },
  {
    merchant: "JioSaavn",
    ...
    cancellationPolicy: "Cancel auto-renew from your payment source or app settings.",
    difficulty: "medium"
  },
  {
    merchant: "Gaana",
    patterns: ["gaana", "gaana plus"],
    cancellationPolicy: "Cancel from your Google Play or App Store subscriptions.",
    difficulty: "medium",
    instructions: [
  ...
  },
  {
    ...
    cancellationPolicy: "Pause or cancel via the app. Cancellation may involve a fee.",
    difficulty: "medium",
    instructions: [
  ...
  },
  {
    ...
    cancellationPolicy: "Use your remaining credits before cancelling, or you will lose them.",
    difficulty: "hard",
    instructions: [
  ...
  },
  {
    ...
    cancellationPolicy: "Cancel anytime. You will have access until your billing date.",
    difficulty: "easy"
  },
  {
    merchant: "Headspace",
  ...
  },
  {
    ...
    cancellationPolicy: "Cancel at least 24 hours before your next billing date.",
    difficulty: "easy"
  },
  ...
  },
  {
    ...
    cancellationPolicy: "Disable auto-renewal from Paytm app > Profile > Paytm First.",
    difficulty: "medium"
  },
  {
    merchant: "Flipkart Plus",
    patterns: ["flipkart plus"],
    cancellationPolicy: "Plus memberships are generally point-based and don't require cancellation.",
    difficulty: "easy"
  },
  {
  ...
  },
  {
    ...
    cancellationPolicy: "Membership is valid for 1 year, usually non-refundable.",
    difficulty: "hard",
    instructions: [
...
export function getMerchantCancellationInfo(merchantName: string): MerchantCancellationInfo {
  ...
  return {
    ...
    patterns: [],
    cancellationPolicy: "Check the merchant's website or app for cancellation instructions. Look for 'Account', 'Billing', or 'Subscriptions' settings.",
    difficulty: "hard",
    instructions: [
