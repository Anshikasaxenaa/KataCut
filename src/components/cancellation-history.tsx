...
const cancelledSubscriptions = [
  {
    id: 1,
    merchant: "Swiggy One",
    cancelledDate: new Date("2026-06-15"),
    amount: 149,
    frequency: "month",
  },
  {
    ...
    cancelledDate: new Date("2026-03-10"),
    amount: 299,
    frequency: "month",
  },
  {
    id: 3,
    merchant: "Cult.fit",
    cancelledDate: new Date("2025-12-01"),
    amount: 1499,
    frequency: "month",
  },
];
      ...
      <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 border-dashed">
        <CardContent className="flex flex-col items-center justify-center p-10 text-center">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-sm">
            When you cancel unused subscriptions using the "Review & Cancel"
            button, they will appear here.
          </p>
        </CardContent>
      </Card>
    );
          ...
          <Table>
            <TableHeader className="bg-zinc-50/50 dark:bg-zinc-950/30">
              <TableRow className="border-zinc-100 dark:border-zinc-800">
                ...
                <TableHead className="font-medium text-zinc-500 hidden sm:table-cell">
                  Cancelled On
                </TableHead>
                <TableHead className="font-medium text-zinc-500">
                  Amount Saved
                </TableHead>
                <TableHead className="font-medium text-zinc-500 text-right">
                  Total Saved
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {cancelledSubscriptions.map((sub) => {
                ...
                const totalSaved = calculateSavedSince(
                  sub.cancelledDate,
                  monthlyAmount,
                );
                  ...
                  >
                    <TableCell className="font-medium">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          variant="outline"
                          className="bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/20 text-[10px] py-0 hidden md:inline-flex"
                        >
                          Cancelled
                        </Badge>
                      </div>
                    ...
                    <TableCell className="text-zinc-500 hidden sm:table-cell">
                      {sub.cancelledDate.toLocaleDateString("en-IN", {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                      })}
