  ...
  return (
    <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-[0_2px_20px_rgb(0,0,0,0.04)] h-full flex flex-col relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <h2 className="text-xl font-bold text-[#393E41]">Projects Timeline</h2>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 bg-[#E94F37] hover:bg-[#C13D29] text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-colors">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 relative">
        ...
        <div className="lg:col-span-3 flex flex-col justify-between relative z-10 space-y-6 lg:space-y-0">
          ...
          <div className="mb-4">
            <h3 className="text-3xl font-bold text-[#393E41]">21</h3>
            <div className="flex items-center justify-between mt-1 text-[#393E41]/60 font-medium text-sm">
              <span>Upcoming Tasks</span>
              <ArrowUpRight className="w-4 h-4 text-[#393E41]/40" />
            </div>
          </div>

          <div className="bg-[#E94F37] rounded-[24px] p-6 text-white shadow-xl relative w-full lg:w-64">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-3">
                <div className="bg-white text-[#E94F37] px-4 py-1.5 rounded-full text-sm font-medium w-28 text-center">In Test</div>
                <div className="flex-1 h-8 rounded-full border border-dashed border-white/40"></div>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-white text-[#E94F37] px-4 py-1.5 rounded-full text-sm font-medium w-28 text-center">Reviewed</div>
                <div className="flex-1 h-8 rounded-full border border-dashed border-white/40"></div>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-white text-[#E94F37] px-4 py-1.5 rounded-full text-sm font-medium w-28 text-center">Complete</div>
                <div className="flex-1 h-8 rounded-full border border-dashed border-white/40"></div>
              </div>
            </div>
        ...
        <div className="lg:col-span-9 relative w-full h-[320px] overflow-hidden lg:pl-4">
          {/* Header row */}
          <div className="flex justify-between text-xs font-semibold text-[#393E41]/40 mb-6 pl-[5%]">
            {['2M', '3T', '4W', '5T', '6F', '7S', '8S', '9M', '10T', '11W', '12T', '13F'].map((day, i) => (
              <div key={day} className={`w-8 h-8 flex items-center justify-center rounded-full ${day === '6F' ? 'bg-[#E94F37] text-white shadow-md z-10' : ''}`}>
                {day}
              </div>
            ))}
          </div>
          ...
          <div className="absolute top-[40px] bottom-0 left-[41.5%] w-0.5 bg-[#E94F37]/20 z-0"></div>
          ...
          <div className="relative z-10 w-full h-full mt-4">
            ...
            <div className="absolute top-[10px] left-[65%] flex items-center bg-white rounded-full p-1.5 pr-2 shadow-sm border border-dashed border-zinc-300">
              ...
              <div className="ml-2 mr-6">
                <div className="text-xs font-bold text-[#393E41]">Mobile app</div>
                <div className="text-[10px] text-[#393E41]/60 font-medium">5 hours</div>
              </div>
              <div className="w-7 h-7 rounded-full bg-[#393E41] text-white flex items-center justify-center text-[10px] font-bold shadow-md">
                69%
              </div>
            </div>

            {/* Web Design */}
            <div className="absolute top-[80px] left-[25%] flex items-center bg-[#E94F37] text-white rounded-full p-1.5 pr-3 shadow-lg">
              ...
              <div className="w-6 h-6 rounded-full bg-white text-[#E94F37] flex items-center justify-center shadow-sm">
            ...
            <div className="absolute top-[150px] left-[55%] flex items-center bg-white rounded-full p-1.5 pr-2 shadow-sm border border-dashed border-zinc-300">
              ...
              <div className="ml-2 mr-6">
                <div className="text-xs font-bold text-[#393E41]">Website Design</div>
                <div className="text-[10px] text-[#393E41]/60 font-medium">5 hours</div>
              </div>
              <div className="w-7 h-7 rounded-full bg-[#393E41] text-white flex items-center justify-center text-[10px] font-bold shadow-md">
                78%
            ...
            <div className="absolute top-[220px] left-[5%] flex items-center bg-white rounded-full p-1.5 pr-2 shadow-sm border border-dashed border-zinc-300">
              ...
              <div className="ml-2 mr-6">
                <div className="text-xs font-bold text-[#393E41]">UX Kit</div>
                <div className="text-[10px] text-[#393E41]/60 font-medium">6 hours</div>
              </div>
              <div className="w-7 h-7 rounded-full bg-[#393E41] text-white flex items-center justify-center text-[10px] font-bold shadow-md">
                57%
              </div>
