  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      ...
      <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-[0_2px_20px_rgb(0,0,0,0.04)] flex-1">
        <h2 className="text-xl font-bold text-[#393E41] mb-6">Team Insights</h2>
        ...
        <div className="h-24 w-full flex items-end gap-1 mb-6">
          {[40, 60, 45, 80, 50, 70, 90, 55, 65, 40, 85, 75, 45, 60, 50, 70, 30, 80, 65, 95, 55, 70, 45, 85, 60].map((height, i) => (
            <div 
              key={i} 
              className={`flex-1 rounded-t-sm ${i === 20 ? 'bg-[#E94F37]' : 'bg-[#393E41]/10'}`}
              style={{ height: `${height}%` }}
            ></div>
          ))}
        </div>
      ...
      <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-[0_2px_20px_rgb(0,0,0,0.04)]">
        <h2 className="text-xl font-bold text-[#393E41] mb-4">Time Tracker</h2>
        
        <div className="flex items-center justify-between">
          <div>
            <div className="text-4xl font-bold text-[#393E41] tracking-tight">08:40:20</div>
            <div className="text-sm text-[#393E41]/60 font-medium mt-2">On Going Start Hi-Fi New Project</div>
          </div>
          <button className="w-12 h-12 rounded-full bg-[#E94F37] hover:bg-[#C13D29] text-white flex items-center justify-center shadow-lg shadow-[#E94F37]/30 transition-colors shrink-0">
